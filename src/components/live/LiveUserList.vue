<template>
    <div>
        ...
        <el-card shadow="always" :body-style="{ padding: '20px' }">
            ...
            <!-- 分页 -->
            <el-pagination @size-change="sizeChange" @current-change="currentChange" :current-page.sync="params.currentPage"
                :page-sizes="[5, 10, 15]" :page-size="params.pageSize" layout="total, sizes, prev, pager, next, jumper"
            ...
            <el-form :model="editModel" ref="editForm" label-width="80px" :inline="true" size="small">
                ...
                <el-form-item label="角色">
                    <el-select v-model="editModel.roleId">
                        <el-option :label="'aa'" :value="111" :selected="111"></el-option>
        ...
        <!-- 分配房屋 -->
        <el-dialog :title="assignHouseDialog.title" :visible.sync="assignHouseDialog.visible"
            ...
            <el-pagination @size-change="assignHouseSize" @current-change="assignHouseChange"
                :current-page.sync="houseParams.currentPage" :page-sizes="[5, 10, 15]" :page-size="houseParams.pageSize"
                layout="total, sizes, prev, pager, next, jumper" :total="houseParams.total" background>
            </el-pagination>
