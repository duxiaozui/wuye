        ...
        <el-card shadow="always" :body-style="{ padding: '20px' }">
            ...
            <el-table :data="tableList" border stripe>
                ...
                <el-table-column label="在职状态" prop="status">
                    <template slot-scope="scope">
                        <el-switch v-model="scope.row.status" :active-value="0" active-text="在职" :inactive-value="1"
                            inactive-text="离职" @change="">
                        </el-switch>
                    </template>
                </el-table-column>
                <el-table-column label="是否可用" prop="enabled">
                    <template slot-scope="scope">
                        <el-switch v-model="scope.row.enabled" :active-value="true" active-text="可用" :inactive-value="false"
                            inactive-text="禁用" @change="changeUserEnabled(scope.row)">
                        </el-switch>
                    </template>
                </el-table-column>
