                ...
                <el-table-column label="操作" width="300px" align="center">
                    <template slot-scope="scope">
                        <el-button type="primary" icon="el-icon-edit" size="small"
                            @click="editFeePower(scope.row)">编辑</el-button>
                        <el-button type="primary" icon="el-icon-delete" size="small"
                            @click="deleteFeePower(scope.row)">删除</el-button>
                        <el-button type="primary" icon="el-icon-edit" size="small"
                            @click="payFeePower(scope.row)">缴费</el-button>
                    </template>
                </el-table-column>
            </el-table>
            ...
            <el-form :model="editModel" ref="editForm" label-width="80px" :inline="true" size="small">
                ...
                <el-form-item label="房屋编号">
                    <el-select v-model="editModel.houseId">
                        <el-option v-for="item in houseList" :key="item.houseId" :label="item.houseNum"
                            :value="item.houseId">
                        </el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="所属月份">
                    <el-date-picker v-model="editModel.payPowerMonth" format="yyyy-MM" value-format="yyyy-MM"
