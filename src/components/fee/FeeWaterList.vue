                ...
                <el-table-column label="操作" width="300px" align="center">
                    <template slot-scope="scope">
                        <el-button type="primary" icon="el-icon-edit" size="small"
                            @click="editFeeWater(scope.row)">编辑</el-button>
                        <el-button type="primary" icon="el-icon-delete" size="small"
                            @click="deleteFeeWater(scope.row)">删除</el-button>
                        <el-button type="primary" icon="el-icon-edit" size="small"
                            @click="payFeeWater(scope.row)">缴费</el-button>
                    </template>
                </el-table-column>
            </el-table>
        ...
        <el-dialog :title="editDialog.title" :visible.sync="editDialog.visible" :width="editDialog.width">
            <el-form :model="editModel" ref="editForm" label-width="80px" :inline="true" size="small">
                ...
                <el-form-item label="所属月份">
                    <el-date-picker v-model="editModel.payWaterMonth" format="yyyy-MM" value-format="yyyy-MM"
